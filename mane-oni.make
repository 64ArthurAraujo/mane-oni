...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/mane-oni
OBJDIR = obj/x64/Debug/mane-oni
...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/mane-oni
OBJDIR = obj/ARM64/Debug/mane-oni
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
TARGET = $(TARGETDIR)/mane-oni
OBJDIR = obj/x64/Release/mane-oni
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/mane-oni
OBJDIR = obj/x86/Release/mane-oni
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/mane-oni
OBJDIR = obj/ARM64/Release/mane-oni
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
$(OBJDIR)/entity.o: src/entities/entity.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/oni.o: src/entities/oni.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/player.o: src/entities/player.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
...
$(OBJDIR)/gameplay.o: src/screens/gameplay.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/menu.o: src/screens/menu.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
